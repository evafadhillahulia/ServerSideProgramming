  ...
  if (!user?.permissions?.includes("mahasiswa.page")) {
    return (
      <div className="flex justify-center items-center h-64">
        <p className="text-xl text-red-600 font-semibold">🚫 Anda tidak memiliki izin untuk melihat halaman ini.</p>
      </div>
    );
  }
                ...
                <tr key={mhs.id} className="even:bg-gray-100 odd:bg-white">
                  ...
                  <td className="py-2 px-4 text-center space-x-2">
                    <Button
                      ...
                      onClick={() => navigate(`/dashboard/mahasiswa/${mhs.id}`, { state: mhs })}
                    >
                      Detail
                    </Button>
