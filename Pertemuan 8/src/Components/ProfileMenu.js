// ProfileMenu.js => src/Components/ProfileMenu.js

import { useState } from "react";
import { FaUserCircle, FaSignOutAlt, FaUser } from "react-icons/fa";
import { confirmLogout } from "../Utils/Helpers/SwalHelper"; // Import swalHelper for confirmation

const ProfileMenu = () => {
  const [isOpen, setIsOpen] = useState(false);

  const handleLogout = () => {
    // Use swalHelper to confirm logout
    confirmLogout(() => {
